  ...
  return (
    <div className="p-6 space-y-6 animate-fade-up">
      ...
      <div className="rounded-xl border border-white/8 overflow-hidden"
        style={{ background: 'rgba(255,255,255,0.02)' }}>
        <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1.5fr] gap-4 px-5 py-3 border-b border-white/8 text-xs text-white/30 uppercase tracking-wide font-medium">
        ...
        {loading ? (
          ...
          <div className="divide-y divide-white/5">
            {filtered.map(a => {
              ...
              return (
                <div key={a.id} className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1.5fr] gap-4 items-center px-5 py-3.5 hover:bg-white/2 transition-colors">
                  <div>
                  ...
                  <div className="text-sm text-white/50 truncate">{a.donor?.name ?? '—'}</div>
