    ...
    <div className="p-4 md:p-6 space-y-6 animate-fade-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-gray-200 p-5" style={{ background: '#FFFFFF' }}>
          <div className="text-xs text-gray-500 uppercase tracking-wider font-medium mb-3">Current Plan</div>
          ...
          {data?.subscription && (
            <button onClick={handlePortal} disabled={portalLoading}
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium border border-gray-200 text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-all disabled:opacity-40">
        ...
        {/* Usage cards */}
        <div className="rounded-xl border border-gray-200 p-5" style={{ background: '#FFFFFF' }}>
          <div className="text-xs text-gray-500 uppercase tracking-wider font-medium mb-4">Usage</div>
        ...
        {/* Quick stats */}
        <div className="rounded-xl border border-gray-200 p-5" style={{ background: '#FFFFFF' }}>
          <div className="text-xs text-gray-500 uppercase tracking-wider font-medium mb-4">Plan Includes</div>
            ...
            return (
              <div key={plan.id}
                ...
                <div className="mb-4">
                  ...
                  {plan.subLabel && (
                    <span className="text-sm text-gray-500 ml-1">{plan.subLabel}</span>
                  )}
                </div>
                ...
                {isCurrent ? (
                  ...
                  <a href="mailto:hello@tulipds.com"
                    className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium border border-gray-200 text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-all">
            ...
            {data.invoices.map(inv => (
              <div key={inv.id} className="flex items-center gap-4 px-5 py-3 hover:bg-white transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium text-gray-800">{inv.number || inv.id.slice(0, 20)}</div>
