  ...
  const sidebarContent = (
    <>
      ...
      <div className={clsx(
        ...
        <img src="/logo.svg" alt="sealayer" className="shrink-0 transition-all" style={{ height: collapsed && !mobileOpen ? '40px' : '56px', filter: 'brightness(0) invert(1)' }} />
        ...
        <header className="h-16 border-b border-[var(--tulip-sage-dark)] flex items-center justify-between px-4 md:px-6 shrink-0"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="md:hidden flex items-center">
              <img src="/logo.svg" alt="sealayer" style={{ height: '56px' }} />
            </div>
