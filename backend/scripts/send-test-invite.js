...
const inviteUrl = 'https://donor.sealayer.io/accept-invite?token=test-verification-token'
...
async function main() {
  ...
  const info = await sendEmail({
    ...
    text: `${orgName} has invited you (${donorName}) to view their verified financial records for "${agreementTitle}" on Sealayer.\n\nAccept your invitation here:\n${inviteUrl}\n\nThis is a test email to verify the invite system is working.`,
    html: [
      ...
      `<strong>${orgName}</strong> has invited you (${donorName}) to view their verified financial records for <strong>${agreementTitle}</strong> on Sealayer.`,
      '</p>',
