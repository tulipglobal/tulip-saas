...
export default function HomePage() {
  return (
    <div className="min-h-screen" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[#c8d6c0] backdrop-blur-md bg-[#e1eedd]/95">
          ...
          {[
            ...
            <div key={stat.label} className="text-center">
              <p style={{ fontFamily: 'Inter, sans-serif', fontWeight: 800, fontSize: '36px', color: '#183a1d' }}>
                {stat.value}<span style={{ color: '#f6c453' }}>{stat.suffix}</span>
              </p>
              <p style={{ color: '#183a1d', fontSize: '13px', marginTop: '4px', opacity: 0.6 }}>{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={product.title}
                className="group p-6 rounded-2xl border border-[#c8d6c0] bg-[#e1eedd] hover:border-[#c8d6c0] transition-all cursor-pointer">
                ...
                <h3 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '22px', color: '#183a1d', marginTop: '6px' }}>
                  {product.title}
                </h3>
                <p style={{ color: '#183a1d', opacity: 0.6, fontSize: '14px', lineHeight: 1.6, marginTop: '8px' }}>
                  {product.desc}
                </p>
      ...
      {/* HOW IT WORKS */}
      <section className="bg-[#fefbe9] py-24 border-t border-[#c8d6c0]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={step.step} className="text-center">
                ...
                <p style={{ color: '#183a1d', opacity: 0.6, fontSize: '14px', lineHeight: 1.6, marginTop: '6px' }}>
                  {step.desc}
                </p>
              </div>
            ))}
      ...
      {/* FOOTER */}
      <footer className="bg-[#fefbe9] border-t border-[#c8d6c0] py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: '#f6c453' }}>
                <Shield className="w-3.5 h-3.5 text-[#183a1d]" />
              </div>
              <span style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, color: '#183a1d', fontSize: '16px' }}>
                tulip<span style={{ color: '#f6c453' }}>ds</span>
              </span>
            </div>
